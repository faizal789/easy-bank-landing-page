const Footer = () => {
  return (
    <footer className="flex justify-between items-center px-28 py-20 bg-dark-blue-primary max-lg:flex-col max-lg:gap-8 max-lg:py-10">
      <div className="flex gap-32 max-lg:flex-col max-lg:gap-5">
        <div className="flex flex-col justify-between max-lg:gap-5 max-lg:items-center">
          <img
          ...
          <div className="flex gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer" width="20" height="20">
              <path
                className="fill-white hover:fill-lime-green-primary"
                d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0z"
              />
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer" width="21" height="20">
              <path
                  className="fill-white hover:fill-lime-green-primary"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer" width="21" height="18">
              <path
                 className="fill-white hover:fill-lime-green-primary"
        ...
        <div className="flex flex-col text-white gap-2 max-lg:text-center">
          <span className="hover:text-lime-green-primary cursor-pointer">
            About Us
          </span>
          <span className="hover:text-lime-green-primary cursor-pointer">
            Contact
      ...
      <div className="flex flex-col gap-5 items-end max-lg:items-center max-lg:text-center">
